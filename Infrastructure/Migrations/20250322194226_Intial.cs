        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerAddress_AddressLine = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerAddress_UnitNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerAddress_StreetNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerAddress_NearestLandMark = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingCosts", x => new { x.ShippingMethodId, x.Governate });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedAccountNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingMethodId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CustomerAddress_AddressLine = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_ShippingCosts_ShippingMethodId_Governate",
                        columns: x => new { x.ShippingMethodId, x.Governate },
                        principalTable: "ShippingCosts",
                        principalColumns: new[] { "ShippingMethodId", "Governate" },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishlistItems", x => new { x.ProductId, x.WishlistId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingMethodId_Governate",
                table: "Orders",
                columns: new[] { "ShippingMethodId", "Governate" });
